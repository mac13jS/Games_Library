...
class AlreadyPlayedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_already_played, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        spinner = view.findViewById(R.id.alreadyPlayedProgressBar)
        recyclerView = view.findViewById(R.id.alreadyPlayedRecyclerView)
